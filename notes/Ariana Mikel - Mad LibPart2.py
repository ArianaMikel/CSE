...
'''
name_list = ["Enter a name", "Enter a noun", "Enter an adjective", "Enter a adjective", "Enter a adjective ",
              "Enter a verb", "Enter a noun", "Enter a noun", "Enter a number", "Enter a noun (plural)", "Enter a verb",
              "Enter a number"]
input(name_list)
